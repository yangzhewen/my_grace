...
def init_ae_model(qmap_quality=1):
    ...
    models = {
            "128": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/128_pretrain.model"})),
            "256": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/256.model"})),
            "512": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/512.model"})),
            "1024": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/1024.model"})),
            "2048": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/2048.model"})),
            "4096": AEModel(qmap_coder, GraceInterface({"path": f"{PRETRAIN_PREFIX}/4096_pretrain.model"})),
            }
